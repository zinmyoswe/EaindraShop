   ...
   <div class="col-md-8">
          ...
          <div class="card">
            <div class="card-header with-border">
              <h3 class="card-title">NEW STAFF ADD FORM</h3>
            </div>
            <!-- /.box-header -->
            <?php
              if(isset($errMSG)){
            ...
            <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
              ...
              <div class="card-footer">
                <button type="submit" class="btn btn-default float-right" style="margin-left: 4px;">Cancel</button>
                <button type="submit" name="btnsave" class="btn btn-warning float-right">Save</button>
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
