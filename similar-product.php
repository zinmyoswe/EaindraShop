...
<div class="container">
            ...
            <div class="blog">
                <h2 style="font-size: 28px; text-align: center;">SIMILAR PRODUCTS</h2>
  <br>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 col-xs-6">
                                        <a href="detail2.php?id=<?php echo $row_similar['id']; ?>">
                                            <img src="admin/cover/<?php echo $row_similar['cover'] ?>" alt="Image" style="width: 250px; height:250px;" class="img-responsive">
                                            
                                        </a>

                                        <p style="height: 32px; margin-top: 10px; font-weight: 400; font-size: 14px;"><a href="detail2.php?id=<?php echo $row_similar['id']; ?>"><?php echo $row_similar['product_name']; ?></a></p>
                                        <p style="font-weight: 400; margin-top: 10px; font-size: 14px;">$<?php echo $row_similar['price']; ?></p>
                                    </div>
                                   <?php endwhile; ?>
                  ...
                  ?>
                                    <div class="col-sm-3 col-xs-6">
                                        <a href="detail2.php?id=<?php echo $row_similar2['id']; ?>">
                                            <img src="admin/cover/<?php echo $row_similar2['cover'] ?>" alt="Image" style="width: 250px; height:250px;" class="img-responsive">
                                            
                                        </a>
                                        <p style="height: 32px; margin-top: 10px; font-weight: 400; font-size: 14px;"><a href="detail2.php?id=<?php echo $row_similar2['id']; ?>"><?php echo $row_similar2['product_name']; ?></a></p>
                                        <p style="font-weight: 400; margin-top: 10px; font-size: 14px;">$<?php echo $row_similar2['price']; ?></p>
                                    </div>
                                <?php endwhile; ?>
                                </div>
                                <!--.row-->
